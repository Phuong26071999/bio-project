  ...
  return (
    <div className={`coverHeader${flagSroll}`}>
      <a href="#home" className="logo">
        <img src={logo} alt="HP logo" className="logo-img" />
        {/* <span className="logo-text">Hoang Phuong</span> */}
      </a>
        ...
        openMenu && (
          <nav className="navbar">
            <a
              ...
              className={flagActive === "Home" ? "active" : ""}
            >
              Home
            </a>
            <a
              ...
              className={flagActive === "About" ? "active" : ""}
            >
              About
            </a>
            <a
              ...
              className={flagActive === "Skills" ? "active" : ""}
            >
              Skills
            </a>
            <a
              ...
              className={flagActive === "Projects" ? "active" : ""}
            >
              Projects
            </a>
            <a
              ...
              className={flagActive === "Contact" ? "active" : ""}
            >
              Contact
            </a>
          </nav>
